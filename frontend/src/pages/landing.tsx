...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-foreground selection:text-background font-sans transition-clean flex flex-col items-center py-20 md:py-40">
      ...
      <main className="max-w-xl w-full space-y-16 ">
        ...
        <div className="pt-4">
          <button
            ...
            className="group px-8 py-4 bg-foreground text-background text-lg font-bold rounded-xl flex items-center gap-3 hover:-translate-y-1 transition-all"
          >
            Start writing <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </button>
        </div>

        <div className="grid grid-cols-1 gap-10 pt-16 border-t border-border/10">
          <div className="space-y-2">
            <h3 className="font-bold opacity-80 flex items-center gap-3"> No noise.</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              The editor is just a clean. No popups, no sidebars, no distractions. Just you and your thoughts.
            </p>
          </div>
        ...
        {/* Closing */}
        <div className="pt-10 opacity-30 text-xs font-medium uppercase tracking-[0.2em]">
